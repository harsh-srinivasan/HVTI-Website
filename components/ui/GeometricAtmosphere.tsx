...
/* ================================================================
   HVTI MASTER REUSABLE GEOMETRIC ARCHITECTURAL ATMOSPHERE CANVAS
   File: components/ui/GeometricAtmosphere.tsx

   100% Procedural Vector SVG & CSS Radial Gradient Canvas:
   - Deep #05070D dark corporate canvas base
   - Organic, asymmetrical violet/purple atmospheric nebula glows
   - Subtle architectural blueprint linework, CAD floorplans, test bay wireframes,
     coordinate crosshairs, compass calibration rings & precision nodes (#F97316, #C084FC)
   - Zero raster background image textures (100% vector & CSS)
   - Reusable across Management Office, Laboratory Facilities, Company Overview & future pages
   ================================================================ */

export interface GeometricAtmosphereProps {
  variant?: "default" | "office" | "laboratory" | "about";
  className?: string;
}

export default function GeometricAtmosphere({
  variant = "default",
  className = "",
}: GeometricAtmosphereProps) {
  return (
    <div
      className={`
        pointer-events-none
    ...
    >
      ...
      {/* Mid-Page Right Architectural Glow */}
      <div
        className="
          absolute
          -right-[180px]
      ...
      {/* Lower-Right Coordinate Matrix Nebula */}
      <div
        className="
          absolute
          -right-[120px]
      ...
      <div className="hidden lg:block">
        ...
        >
          <defs>
            <linearGradient id="geomGradFadeH" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#C084FC" stopOpacity="0.48" />
              <stop offset="100%" stopColor="#C084FC" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="geomGradFadeHRev" x1="1" y1="0" x2="0" y2="0">
              <stop offset="0%" stopColor="#C084FC" stopOpacity="0.48" />
              <stop offset="100%" stopColor="#C084FC" stopOpacity="0" />
            </linearGradient>
          </defs>
          ...
          <g>
            ...
            <line x1="20" y1="120" x2="210" y2="120" stroke="url(#geomGradFadeH)" strokeWidth="0.9" />
            <line x1="20" y1="180" x2="160" y2="180" stroke="#C084FC" strokeWidth="0.8" strokeOpacity="0.38" />
            <line x1="20" y1="240" x2="230" y2="240" stroke="url(#geomGradFadeH)" strokeWidth="0.9" />
          ...
          <g>
            ...
            <line x1="1140" y1="480" x2="1440" y2="480" stroke="url(#geomGradFadeHRev)" strokeWidth="0.8" />
            <line x1="1360" y1="300" x2="1360" y2="660" stroke="#C084FC" strokeWidth="0.8" strokeOpacity="0.32" />

            {[0, 1, 2, 3, 4].map((i) =>
              [0, 1, 2, 3].map((j) => (
                <circle
                  key={`geom-top-grid-${i}-${j}`}
                  cx={1240 + i * 36}
                  cy={360 + j * 36}
                  r="1.3"
                  fill="#C084FC"
          ...
          <g>
            ...
            <line x1="0" y1="1480" x2="440" y2="1480" stroke="url(#geomGradFadeH)" strokeWidth="0.9" />
            <line x1="0" y1="1400" x2="340" y2="1400" stroke="url(#geomGradFadeH)" strokeWidth="0.7" strokeDasharray="4 6" />
            <line x1="0" y1="1560" x2="300" y2="1560" stroke="url(#geomGradFadeH)" strokeWidth="0.7" strokeDasharray="4 6" />

            {[0, 1, 2, 3].map((i) =>
              [0, 1, 2, 3, 4].map((j) => (
                <circle
                  key={`geom-mid-left-grid-${i}-${j}`}
                  cx={40 + i * 36}
                  cy={1300 + j * 36}
                  r="1.3"
                  fill="#C084FC"
          ...
          <g>
            ...
            <line x1="880" y1="3600" x2="1440" y2="3600" stroke="url(#geomGradFadeHRev)" strokeWidth="0.9" />
            <line x1="1200" y1="3300" x2="1200" y2="3900" stroke="#C084FC" strokeWidth="0.8" strokeOpacity="0.30" />
            <line x1="960" y1="3520" x2="1440" y2="3520" stroke="url(#geomGradFadeHRev)" strokeWidth="0.7" strokeDasharray="4 6" />
