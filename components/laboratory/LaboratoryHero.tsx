...
/* ================================================================
   VIEWPORT 1 — LABORATORY FACILITIES HERO (FULL MOBILE VIEWPORT)
   File: components/laboratory/LaboratoryHero.tsx
   ================================================================ */
    ...
    >
      ...
      <div className="relative z-10 my-auto flex w-full max-w-[860px] flex-col items-center text-center">
        ...
        >
          ...
          >
            LABORATORY{" "}
            <span className="text-[#A855F7]">FACILITIES</span>
          </h1>
          ...
          >
            ...
            <div className="text-left font-sans text-[12.5px] leading-[1.4] text-[#CBD5E1] drop-shadow-[0_1px_6px_rgba(0,0,0,0.8)] sm:text-[14px]">
              <span className="font-medium text-white">Plot 114, Udyog Vihar, Phase 4,</span>
              <br />
              <span className="text-[#94A3B8]">Gurgaon, Haryana – 122015, India</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <Image
              src="/images/laboratory/hvti-lab-hero-hd.jpg"
              alt="HVTI Laboratory Facility Exterior & Testing Bay"
              fill
              priority
              quality={95}
