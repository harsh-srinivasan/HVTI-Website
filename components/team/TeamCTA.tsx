...
/* ================================================================
   HVTI TEAM — COMPACT SPECIALIST CONSULTATION CTA
   File: components/team/TeamCTA.tsx
   ================================================================ */
    ...
    >
      ...
      >
        ...
        <h2
          ...
          "
        >
          Partner Directly with Our Technical Specialists
        </h2>

        {/* Description */}
        <p className="mx-auto mt-2 max-w-[560px] font-sans text-[12.5px] leading-[1.6] text-[#CBD5E1] sm:text-[13px]">
          Whether you need a customized 300 kV hipot test bench, specialized live-line
          hot sticks, or 24/7 condition monitoring telemetry—our engineers are ready to assist.
        </p>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-4 border-t border-white/[0.06] pt-3 sm:gap-6">
          <div className="flex items-center gap-1.5 font-mono text-[10px] text-[#94A3B8]">
            ...
            <span>Direct Access to R&amp;D Heads</span>
          </div>
          <div className="flex items-center gap-1.5 font-mono text-[10px] text-[#94A3B8]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#F97316]" />
            <span>Custom Hardware Prototyping</span>
          </div>
          <div className="flex items-center gap-1.5 font-mono text-[10px] text-[#94A3B8]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#22C55E]" />
            <span>Pan-India On-Site Commissioning</span>
          </div>
        </div>
      </div>
    </section>
